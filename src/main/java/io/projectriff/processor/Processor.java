...
public class Processor {
    ...
    public Processor(List<FullyQualifiedTopic> inputs, List<FullyQualifiedTopic> outputs, String group, ReactorRiffGrpc.ReactorRiffStub riffStub) {
        this.inputs = inputs;
    ...
    @NotNull
    private static Map<String, ReactorLiiklusServiceGrpc.ReactorLiiklusServiceStub> indexByAddress(List<FullyQualifiedTopic> fullyQualifiedTopics) {
